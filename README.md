...
This repo contains all of the smart contracts used to run [Croco](croco.exchange).
...
## Accessing the ABI
If you need to use any of the contract ABIs, you can install this repo as an npm package with `npm install --dev @crocodex/exchange-contracts`. Then import the ABI like so: `import { abi as ICrocoPairABI } from '@crocodex/exchange-contracts/artifacts/contracts/croco-core/interfaces/ICrocoPair.sol/ICrocoPair.json'`.
